...
// IFriendshipRepository is an autogenerated mock type for the IFriendshipRepository type
type IFriendshipRepository struct {
	mock.Mock
}

// FriendshipExists provides a mock function with given fields: email1, eamil2
func (_m *IFriendshipRepository) FriendshipExists(email1 string, eamil2 string) (bool, error) {
...
func (_m *IFriendshipRepository) GetCommonFriends(email1 string, email2 string) ([]string, error) {
...
func (_m *IFriendshipRepository) GetFriends(email string) ([]string, error) {
	ret := _m.Called(email)
...
func (_m *IFriendshipRepository) GetReceivableUpdates(email string) ([]string, error) {
	ret := _m.Called(email)
...
func (_m *IFriendshipRepository) MakeFriend(friendship model.Friendship) error {
...
func (_m *IFriendshipRepository) UpdateFriendshipStatus(friendship model.Friendship) error {
	ret := _m.Called(friendship)
...
// NewIFriendshipRepository creates a new instance of IFriendshipRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewIFriendshipRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *IFriendshipRepository {
	mock := &IFriendshipRepository{}
	mock.Mock.Test(t)
